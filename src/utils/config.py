...
BIGQUERY_DATASET_SILVER = os.getenv("BIGQUERY_DATASET_SILVER", "pharma_safety_silver")
BIGQUERY_DATASET_GOLD = os.getenv("BIGQUERY_DATASET_GOLD", "pharma_safety_gold")
